...
class Passward():
    ...
    def brutal_extract(self, lengths=[5,6 ], lower=False, upper=False, digit=False, punctuation=False):
        '''
        # 遍历所有可能的密码，暴力破解
...
def main():
    x = Passward(filename="./111.rar", target_path="./")
    x.brutal_extract([4,5,6 ], digit=True, lower=True, upper=False, punctuation=False)
